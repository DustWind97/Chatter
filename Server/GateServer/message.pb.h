...
// int32 rplyuid = 2;
inline void ReplyFriendRsp::clear_rplyuid() {
  rplyuid_ = 0;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReplyFriendRsp::_internal_rplyuid() const {
  return rplyuid_;
}
inline ::PROTOBUF_NAMESPACE_ID::int32 ReplyFriendRsp::rplyuid() const {
  // @@protoc_insertion_point(field_get:message.ReplyFriendRsp.rplyuid)
  return _internal_rplyuid();
}
inline void ReplyFriendRsp::_internal_set_rplyuid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  
  rplyuid_ = value;
}
inline void ReplyFriendRsp::set_rplyuid(::PROTOBUF_NAMESPACE_ID::int32 value) {
  _internal_set_rplyuid(value);
  // @@protoc_insertion_point(field_set:message.ReplyFriendRsp.rplyuid)
}
