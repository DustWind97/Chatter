...
void UserMgr::AddApplyList(std::shared_ptr<ApplyInfo> apply_info)
{
    _apply_list.push_back(apply_info);
}
...
void UserMgr::AppendApplyList(QJsonArray array)
{
    ...
    for (const QJsonValue &value : array) {
        ...
        std::shared_ptr<ApplyInfo> apply_info = std::make_shared<ApplyInfo>(uid, name,desc, icon, nick, sex, status);
        _apply_list.push_back(apply_info);
    }
}
...
void UserMgr::AppendFriendList(QJsonArray array)
{
    ...
    for (const QJsonValue &value : array) {
        ...
        std::shared_ptr<FriendInfo> friend_info = std::make_shared<FriendInfo>(uid, name, nick, icon, sex, desc, back);
